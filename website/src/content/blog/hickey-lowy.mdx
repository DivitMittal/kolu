...
review** has become that. And structural review is exactly what two
agent reviewers — one per axis — aimed at a finished diff and run in
parallel, are good at. The human's remaining job is to pick the lenses, read the
findings, and decide.
