...
export const TerminalSetIconInputSchema = z.object({
  id: TerminalIdSchema,
  /** Empty string clears the icon; any non-empty string sets it. */
  icon: z.string(),
});
...
export const contract = oc.router({
  ...
  terminal: {
    ...
    setIcon: oc.input(TerminalSetIconInputSchema).output(z.void()),
    setCanvasLayout: oc
